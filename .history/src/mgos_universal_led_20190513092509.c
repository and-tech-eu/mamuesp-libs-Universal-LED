...
mgos_rgbleds* mgos_universal_led_create()
{
    ...
    case MGOS_RGBLEDS_TYPE_APA102:
        leds->driver = mgos_neopixel_channeled(pin, leds->panel_width * leds->panel_height, leds->color_order, leds->num_channels);
...
void mgos_universal_led_scale_bitmap(mgos_rgbleds* leds)
{
    ...
    mgos_universal_led_rgb* target = calloc(new_width * new_height, sizeof(mgos_universal_led_rgb));
